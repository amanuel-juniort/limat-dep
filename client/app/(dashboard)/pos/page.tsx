...
export default function PosPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans">
      <div className="max-w-full p-8 lg:p-10">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-8 items-start">
          <div className="space-y-6">
            {/* Integrated Result/Category (Moved from Right) */}
            <div className="bento-card mb-6 p-6 border-none shadow-sm bg-white dark:bg-slate-900 animate-in fade-in slide-in-from-top-4 duration-300">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                ...
                <input
                  ...
                  placeholder="Find items in catalog..."
                ...
                {searchQuery && (
                  <button
                    ...
                    className="mr-3 rounded-full p-1 hover:bg-slate-50"
                  >
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 flex items-center gap-2">
                  <ShoppingBag className="h-3 w-3" /> Product Catalog
                </p>
                ...
                {filteredItems.length === 0 ? (
                  ...
                  filteredItems.map((item) => (
                    <div
                      ...
                      onClick={() => {
                        if (selectedPrizeType === "spin") {
                          saveSpinResult(item.id);
                        } else {
                          addToCart(item);
                        }
                      }}
                      className={cn(
                        "group relative flex flex-col p-4 rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm transition-all hover:shadow-xl hover:-translate-y-1 cursor-pointer overflow-hidden",
                        selectedPrizeType === "spin" && "ring-2 ring-purple-500/20 border-purple-200 bg-purple-50/10",
                    ...
                    >
                      ...
                      <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        {selectedPrizeType === "spin" ? (
                          <Gift className="h-4 w-4 text-purple-500 animate-bounce" />
                        ) : (
                      ...
                      <div className="flex justify-between items-start mb-4">
                        <span className="text-[8px] font-black px-2 py-0.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-500 uppercase tracking-widest">
                      ...
                      <div className="flex-1 mb-4">
                        <h4 className="text-xs font-black text-slate-900 dark:text-white group-hover:text-indigo-600 transition-colors line-clamp-2 leading-tight mb-1">
                          {item.name}
                        </h4>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="h-8 w-8 rounded-xl bg-slate-50 dark:bg-slate-800 flex items-center justify-center text-slate-400 group-hover:bg-indigo-600 group-hover:text-white transition-all shadow-sm">
                          <Plus className="h-4 w-4" />
                        </div>
                      </div>

                      {/* Add overlay check on hover */}
          ...
          <aside className="sticky top-10 h-[calc(100vh-theme(spacing.20))] flex flex-col gap-4 overflow-y-auto custom-scrollbar pr-2">
              ...
              <div className="mb-4">
                ...
                {paymentMethod === "CUSTOM" ? (
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-100 bg-slate-50 px-4 py-5 text-3xl font-black outline-none focus:border-indigo-600 dark:bg-slate-800/50 dark:border-slate-800"
                    placeholder="0.00"
                  />
                )}
              </div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-3">
              <div className="rounded-2xl bg-slate-50 p-4">
                ...
                <p className="text-lg font-black mt-1 text-slate-900">
                  {Number(lastTransaction.totalAmount || total).toFixed(0)} ETB
                </p>
              </div>
              <div className="rounded-2xl bg-indigo-50 p-4 border border-indigo-100">
                ...
                <p className="text-lg font-black mt-1 text-indigo-600">
                  {Number(lastTransaction.tipAmount || tipAmount || 0).toFixed(
                    0,
                  )}{" "}
                  ETB
                </p>
